...
function initMap() {
    ...
    var map = new google.maps.Map(document.querySelector('#map_box'), {
        ...
        center: myLatLng,
        scrollwheel: false,
        styles: [{ elementType: 'geometry', stylers: [{ color: '#242f3e' }] }, { elementType: 'labels.text.stroke', stylers: [{ color: '#242f3e' }] }, { elementType: 'labels.text.fill', stylers: [{ color: '#f2f2f2' }] }, {
    ...
    var island = [{ lat: 44.493278, lng: -81.405753 }, { lat: 44.493351, lng: -81.400751 }, { lat: 44.489310, lng: -81.401057 }, { lat: 44.486870, lng: -81.405140 }, { lat: 44.485960, lng: -81.405548 }, { lat: 44.488132, lng: -81.409032 }, { lat: 44.489007, lng: -81.406782 }, { lat: 44.489979, lng: -81.406116 }, { lat: 44.490269, lng: -81.404982 }, { lat: 44.491531, lng: -81.406300 }];
